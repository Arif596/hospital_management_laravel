        ...
        <div class="col-lg-4">
          <div class="sidebar">
            ...
            <div class="sidebar-block">
              ...
              <p>there are no countries in the world without a single case of coronavirus. 
                The COVID-19 pandemic has spread to almost every corner of the globe, infecting
                 millions of people and causing significant economic and social disruptions. 
                 While some countries have managed to control the spread of the virus through 
                 
                 strict measures such as lockdowns, social distancing, and widespread testing, 
                 
                 no country has been completely immune to the pandemic. However, some countries 
                 have reported very low numbers of cases or even no new cases in recent months, 
                 indicating that their efforts to control the spread of the virus have 
                been successful to some extent.</p>
            </div>
          </div>
        </div> 
      </div> <!-- .row -->
